...
export default async function DashboardKeuanganPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 perspective-normal lg:grid-cols-[0.95fr_1.05fr]">
        <FinanceChart data={chartData} />
        <Card3D variant="glass" className="p-7">
          <div className="badge-primary mb-4 transition-transform duration-300 hover:scale-105">Panduan Penggunaan</div>
          <h3 className="font-heading text-2xl font-semibold tracking-tight">
            Cara mencatat keuangan
          </h3>
          <div className="mt-6 space-y-3">
            <div className="interactive-3d rounded-xl bg-muted/40 p-4">
